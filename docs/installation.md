...
Download the required version of release zip file from [github](https://github.com/andersonz1/grafana-infinity-datasource/releases) and extract into your grafana plugin folder. Then restart Grafana.
...
```shell
grafana-cli --pluginUrl https://github.com/andersonz1/grafana-infinity-datasource/releases/download/v1.0.0/yesoreyeram-infinity-datasource-1.0.0.zip plugins install yesoreyeram-infinity-datasource
```
...
```yml
plugins:
  - https://github.com/andersonz1/grafana-infinity-datasource/releases/download/v1.0.0/yesoreyeram-infinity-datasource-1.0.0.zip;yesoreyeram-infinity-datasource
```
...
```shell
docker run -p 3000:3000 -e "GF_INSTALL_PLUGINS=https://github.com/andersonz1/grafana-infinity-datasource/releases/download/v1.0.0/yesoreyeram-infinity-datasource-1.0.0.zip;yesoreyeram-infinity-datasource" grafana/grafana:8.5.0
```
